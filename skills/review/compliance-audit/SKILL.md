...
2. Dispatch **one** verifier at the pinned worktree from step 1.4. Primary: `codex exec -c
   model_reasoning_effort=high` (effort pinned, model left to Codex's default; rationale in
